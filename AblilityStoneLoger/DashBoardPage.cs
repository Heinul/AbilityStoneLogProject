...
namespace AbilityStoneLoger
{
    internal class DashBoardPage
    {
        ...
        public DashBoardPage(Form1 form1, ResourceLoader resourceLoader, PictureBox[] enhanceGraph, PictureBox[] reductionGraph, Label TryLabel, Label SuccessLabel, Label FailLabel, Label CoinLabel, PictureBox[] itemImages, Label[] imageNames, Label[] successText)
        {
            this.form1 = form1;
